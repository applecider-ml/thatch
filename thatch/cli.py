...
def main():
    ...
    # crossmatch
    p_xmatch = subparsers.add_parser("crossmatch", help="Cross-match transients against HST archive")
    p_xmatch.add_argument("--output", "-o", default="thatch_hst_transients.csv",
                          help="Output CSV path")
    p_xmatch.add_argument("--radius", type=float, default=5.0,
    ...
    p_harvest.add_argument("--radius", type=float, default=5.0,
                           help="Search radius in arcseconds")
    p_harvest.add_argument("--outdir", "-o", default=".", help="Output directory")
    p_harvest.add_argument("--max-download", type=int, default=50,
                           help="Max products to download")

    # photometry
    p_phot = subparsers.add_parser("photometry", help="Run aperture photometry on downloaded images")
    ...
    p_cat.add_argument("--format", choices=["parquet", "csv", "fits"],
    ...
    p_batch.add_argument("--max-download", type=int, default=50,
                         help="Max images per object")
    p_batch.add_argument("--skip-existing", action="store_true", default=True,
    ...
    if args.command == "crossmatch":
        ...
        harvest_object(args.name, args.ra, args.dec,
                       radius=args.radius, outdir=args.outdir,
        ...
        cutouts = extract_cutouts_for_object(args.datadir, args.ra, args.dec,
